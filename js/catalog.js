...
/*choice-slider*/
	var slider = document.getElementById('id66');
    var between = document.getElementById('id66b'); 
    var button1 = document.getElementById('id661');
    var button2 = document.getElementById('id662');   
    var inpt1 = document.getElementById('id66i1'); 
    var inpt2 = document.getElementById('id66i2'); 
    var firstNumber = document.querySelector('.js-firstNumber');
    var secondNumber = document.querySelector('.js-secondNumber');
            var min=inpt1.min;
            var max=inpt1.max;
        ...
        document.onmousemove = function(evt) {
            ...
            if (left1 > left2)
            ...
            else
              {
                ...
                firstNumber.textContent = inpt1.value;
                secondNumber.textContent = inpt2.value;
